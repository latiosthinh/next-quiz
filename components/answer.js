const Answer = ({ choice, choiceName, choiceId, isCorrect }) => {
	return (
		<div className="relative mb-5">
			<input className="sr-only peer" type="radio" name={choiceName} id={choiceId} />

			{ isCorrect && 
				<>
				<label className="flex p-5 bg-slate-700 overflow-hidden border-slate-700 rounded-lg cursor-pointer focus:outline-none hover:bg-gray-600 peer-checked:ring-green-500 peer-checked:ring-2 peer-checked:border-transparent"
					htmlFor={choiceId}>
					{choice.answer}
				</label>
